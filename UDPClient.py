...
Usage:
    ...
    sudo python3 UDPClient.py --server 172.31.41.138 --file test_10mb_file --output-dir received

    # Mock test mode (no sudo needed):
    python3 UDPClient.py --server 127.0.0.1 --file test_10mb_file --output-dir received --mock
"""
